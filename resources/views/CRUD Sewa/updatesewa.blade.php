...
<div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800"><i class="fa fa-edit"></i> Edit Data Sewa</h1>

        <div class="card shadow mb-4">
                <div class="card-body">

                        <form action="  {{ url('sewa/'.$sewa->id_sewa) }} " method="post" enctype="multipart/form-data">
...
<div class="form-group">
        ...
        <input type="text" name="no_sewa" autocomplete="off" required maxlength="16"
        class="form-control @error('no_sewa') is-invalid @enderror" autofocus value="{{ old('no_sewa', $sewa->no_sewa) }}">
        {{-- Erorr Message --}}
        @error('no_sewa')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
...
<div class="form-group">
        ...
        <input type="text" name="tgl_sewa" id="tgl_sewa" required data-provide="inputdate" required value="{{ old('tgl_sewa', $sewa->tgl_sewa ->format('d/m/Y')) }}"
        class="inputdate @error('tgl_sewa') is-invalid @enderror" style="width: 100%;" placeholder="YYYY-MM-DD" maxlength="10">
        @error('tgl_sewa')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
</div>
<div class="form-group">
        ...
        <input type="text" name="tgl_kembali" id="tgl_kembali" required data-provide="inputdate" required value="{{ old('tgl_kembali', $sewa->tgl_kembali ->format('d/m/Y')) }}"
        class="inputdate @error('tgl_kembali') is-invalid @enderror" style="width: 100%;" placeholder="YYYY-MM-DD" maxlength="10">
        @error('tgl_kembali')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
</div>
<div class="form-group">
        ...
        <input type="text" name="lama_sewa" autocomplete="off" required value="{{ old('lama_sewa', $sewa->lama_sewa) }}"
...
<div class="form-group">
        ...
        <input type="text" name="biaya_sewa" autocomplete="off" required value="{{ old('biaya_sewa', $sewa->biaya_sewa) }}"
...
<div class="form-group">
        <label>Denda</label>
        <input type="text" name="denda" autocomplete="off" required value="{{ old('denda', $sewa->denda) }}"
...
<div class="form-group">
        ...
        <input type="text" name="keterangan_denda" autocomplete="off" required value="{{ old('keterangan_denda', $sewa->keterangan_denda) }}"
...
<div class="form-group">
        ...
        <input type="text" name="total_biaya" autocomplete="off" required value="{{ old('total_biaya', $sewa->total_biaya) }}"
