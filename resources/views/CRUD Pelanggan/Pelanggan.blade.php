...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<a class="btn btn-primary btn-icon-split btn-sm mb-2" href="pelanggan/create">
			<span class="icon text-white-50">
				<i class="fa fa-plus-circle" aria-hidden="true"></i>
			</span>
			<span class="text">Tambah Data</span>
		</a>
		<a href="pelanggan/cetak/cetakdatapelanggan" class="btn btn-primary btn-icon-split btn-sm mb-2" target="_blank">
			<span class="icon text-white-50">
				...
				<tbody>
					...
					<tr>
						<td style="width: 10px; text-align:center;">
							{{-- BUTTON VIEW DETAIL --}}
							<a href=" {{ url('pelanggan/'.$item->id_pelanggan) }} " class="btn btn-info btn-icon-split" style="width: 35px; height: 35px">
								<span class="icon text-white-50">
									<i class="fa fa-eye"></i>
								</span>
							</a>
							{{-- BUTTON UBAH --}}
							<a href=" {{ url('pelanggan/'.$item->id_pelanggan.'/edit') }} " class="btn btn-primary btn-icon-split" style="width: 35px; height: 35px">
								<span class="icon text-white-50">
							...
							{{-- BUTTON HAPUS --}}
							<form action="{{ url('pelanggan/'.$item->id_pelanggan) }}" method="post" onsubmit="return confirm('Yakin Hapus Data?')" class="d-inline">
